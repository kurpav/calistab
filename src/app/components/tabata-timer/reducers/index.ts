...
import * as fromTabataTimer from './tabata-timer';
import * as fromRoot from '../../../reducers';

export interface TabataTimerState {
  tabataTimer: fromTabataTimer.State;
}
...
export const reducers = {
  tabataTimer: fromTabataTimer.reducer,
};
 ...
 */
export const getTabataTimerState = createFeatureSelector<TabataTimerState>('tabataTimer');
